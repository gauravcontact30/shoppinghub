    ...
    <form id={form.id} onSubmit={form.onSubmit} action={action}>
      ...
      <Card className="mt-5">
        <CardHeader>
          ...
          <CardDescription>In this form you can <strong>create</strong> your product</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <Select key={fields.category.key} name={fields.category.name} defaultValue={fields.category.initialValue}>
                ...
                <SelectContent>
                  {categories.map((category) => (
                    <SelectItem value={category.name} key={category.id}>{category.title}</SelectItem>
                  ))}
                </SelectContent>
              </Select>
        ...
        <CardFooter>
          <SubmitButton variant="outline" text="Create Product" />
        </CardFooter>
      </Card>
    </form>
  );
